...
// log(q0*inv(q1))
function invLogProduct(w0: number, x0: number, y0: number, z0: number, w1: number, x1: number, y1: number, z1: number) {
...
export function squad(q0: Q, q1: Q, q2: Q, q3: Q): (t: number) => Q {
