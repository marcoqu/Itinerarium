import { Map, LngLatLike, CameraOptions, FreeCameraOptions, PaddingOptions, MercatorCoordinate } from 'mapbox-gl';
...
export declare function getCameraFromBoxAndBearing(map: Map, box: [LngLatLike, LngLatLike], bearing: number, padding?: PaddingOptions, maxZoom?: number): FreeCameraPosition;
...
export declare function zoomToAltitude(map: Map, lat: number, zoom: number, pitch: number): number;
export declare function altitudeToZoom(map: Map, lat: number, altitude: number, pitch?: number): number;
